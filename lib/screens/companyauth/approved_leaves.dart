          ...
          child:  Column(
            ...
            children: [
              ...
              child: Padding(
                ...
                child: Text("Approved Requests", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),),
              )),
              Expanded(
                                    ...
                                    children: [
                                      Column(
                                        children: [
                                          ...
                                          onPressed: (){}, child:  Text("Approved", style: TextStyle(color: Colors.green[900]),)),
                                  ],
                                      ),
                                    ],
                                  )
